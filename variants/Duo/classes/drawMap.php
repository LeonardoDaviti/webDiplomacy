...
class Transform_drawMap extends drawMap
{
	...
	protected function drawTransform($fromTerrID, $toTerrID, $success)
	{
		...
		// (int)round(): the raw expression is 1.5x an odd pixel width (37.5 for contrib/fleet.png,
		// 19.5 for smallfleet.png), and PHP 8.4 deprecates passing a non-integral float to
		// imagefilledellipse()'s int parameters.
		$width=(int)round($this->fleet['width']*1.5);
