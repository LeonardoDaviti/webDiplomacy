...
class ClassicIERVariant extends WDVariant {
	...
	// LOCAL FIX: the apostrophe in "Russia's" was not escaped by admincp's
	// updateVariantInfo action, which interpolates the description straight into SQL and
	// died with a syntax error. Reworded to avoid the apostrophe; nothing else changed.
	public $description='The standard Diplomacy map of Europe, but with Russia, England and Italy as the only playable countries. To offset the balance of the four Russian builds, England gians Holland as a home suppply center while Italy gains trieste - each for based on historical links.';
